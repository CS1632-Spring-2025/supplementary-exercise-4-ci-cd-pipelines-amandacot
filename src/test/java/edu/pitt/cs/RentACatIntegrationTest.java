...
public class RentACatIntegrationTest {
	...
	public void testRentCatFailureNumCats3() {
		...
		r.addCat(c1);
    		...
    		// Clear the output buffer before the second attempt
    		out.reset();

    		// Attempt to rent the same cat again
    		assertFalse(r.rentCat(2));

    		// Ensure only the failure message is printed
	...
	public void testReturnCatNumCats3() {
		...
		r.addCat(c1);
    		...
    		// Clear the captured output **before testing returnCat()**
    		out.reset();
