...
public class CatUnitTest {
	...
	public void testGetId() {
		// TODO: Fill in
		 assertEquals("ID should be 1", 1, c.getId());
	}
	...
	public void testGetName() {
		// TODO: Fill in
		assertEquals("Name should be 'Jennyanydots'", "Jennyanydots", c.getName());
	}
	...
	public void testToString() {
		// TODO: Fill in
		assertEquals("toString() should return 'ID 1. Jennyanydots'", "ID 1. Jennyanydots", c.toString());
	}
	...
	public void testReturnCat() {
		// TODO: Fill in
		c.rentCat(); // Rent the cat first
        	c.returnCat(); // Then return the cat
	...
	public void testRenameCat() {
		// TODO: Fill in
		c.renameCat("Garfield"); // Rename the cat
        	assertEquals("Name should be 'Garfield' after renaming", "Garfield", c.getName());
        	assertEquals("toString() should reflect the new name", "ID 1. Garfield", c.toString());
	}
