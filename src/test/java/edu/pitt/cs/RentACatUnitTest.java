...
public class RentACatUnitTest {
	...
	public void testGetCatNullNumCats0() {
		try {
        	// Get the private method reference using reflection
        	...
        	// Invoke the private method and check that it returns null
	...
	public void testGetCatNumCats3() {
		...
		try {
        		...
        		// Invoke the private method and check that it returns the expected Cat
	...
	public void testListCatsNumCats3() {
		// TODO: Fill in
		// Ensure mocks return expected `toString()` values
    		when(c1.toString()).thenReturn("ID 1. Jennyanydots");
    		when(c2.toString()).thenReturn("ID 2. Old Deuteronomy");
    		when(c3.toString()).thenReturn("ID 3. Mistoffelees");
    		...
    		// Verify that the mocked Cats' toString() is used in listCats()
